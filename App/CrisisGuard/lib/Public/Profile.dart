...
class PublicViewProfile extends StatefulWidget {
  const PublicViewProfile({super.key});

  @override
  State<PublicViewProfile> createState() => _PublicViewProfileState();
}

class _PublicViewProfileState extends State<PublicViewProfile> {
  String name = "";
  String gender = "";
  String dob = "";
  String district = "";
  ...
  Future<void> viewProfile() async {
    try {
      ...
      String url = ip + "public_view_profile";
  ...
  void _editProfile() async {
    bool result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PublicEditProfile(
          id: id,
          name: name,
          gender: gender,
          dob: dob,
